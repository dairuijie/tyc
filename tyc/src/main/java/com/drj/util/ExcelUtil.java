...
public class ExcelUtil {
    ...
    public static final String DIR_PATH = "E://tyc.xlsx";
    public static String arry[] = { "companyName", "phone", "11", "71"};
    ...
    public static void DealExcel(JSONArray jsonArray) {
        ...
        try {
            ...
            row = sheet.createRow((short) (num)); // 对总行数减4，就是倒数行数加数据
    ...
    public static void main(String[] args) {
        String name = "北京市西城区复兴门内大街28号凯晨世贸中心东座F4层939室附近公司";
        System.out.println(name.replace("室附近公司", ""));
    }
}
